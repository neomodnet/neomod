...
// multiple entries
void log(std::string_view text, Color color = 0xffffffff);
...
[[nodiscard]] std::string_view cycleHistory(int dir);
...
[[nodiscard]] std::vector<Suggestion> getSuggestions(std::string_view input);
};  // namespace Console
