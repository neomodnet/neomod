...
CONVAR(clear, CLIENT | NOLOAD, CFUNC(Console::clearLog));
...
CONVAR(console_window_alpha, 0.8f, CLIENT | SKINS, "opacity of the console window's background (the text stays opaque)",
       Range{0.001, 1.});
